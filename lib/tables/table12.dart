...
class Table12 extends StatefulWidget {
  ...
  @override
  State<Table12> createState() => _Table12State();
}

class _Table12State extends State<Table12> {
        ...
        onPressed: () {
          ...
          if (ans1 == 24 &&
            ...
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => const Table13()));
            const snackBar = SnackBar(
